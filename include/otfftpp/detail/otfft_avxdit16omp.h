...
#include "otfftpp/detail/otfft_avxdit8omp.h"
    ...
    template <int n, int s> struct fwdcore
    {
                ...
                complex_vector x, complex_vector y, const_complex_vector W) const noexcept
        {
            ...
            for (int i = 0; i < Ni; i++) {
                ...
                const zmm w8p = mulpz4(w4p,w4p);
                const zmm w9p = mulpz4(w4p,w5p);
                const zmm wap = mulpz4(w5p,w5p);
                const zmm wbp = mulpz4(w5p,w6p);
                const zmm wcp = mulpz4(w6p,w6p);
                const zmm wdp = mulpz4(w6p,w7p);
                const zmm wep = mulpz4(w7p,w7p);
                const zmm wfp = mulpz4(w7p,w8p);

                const zmm y0 =             getpz4(yq_s16p+s*0x0);
                const zmm y1 = mulpz4(w1p, getpz4(yq_s16p+s*0x1));
                const zmm y2 = mulpz4(w2p, getpz4(yq_s16p+s*0x2));
                const zmm y3 = mulpz4(w3p, getpz4(yq_s16p+s*0x3));
                const zmm y4 = mulpz4(w4p, getpz4(yq_s16p+s*0x4));
                const zmm y5 = mulpz4(w5p, getpz4(yq_s16p+s*0x5));
                const zmm y6 = mulpz4(w6p, getpz4(yq_s16p+s*0x6));
                const zmm y7 = mulpz4(w7p, getpz4(yq_s16p+s*0x7));
                const zmm y8 = mulpz4(w8p, getpz4(yq_s16p+s*0x8));
                const zmm y9 = mulpz4(w9p, getpz4(yq_s16p+s*0x9));
                const zmm ya = mulpz4(wap, getpz4(yq_s16p+s*0xa));
                const zmm yb = mulpz4(wbp, getpz4(yq_s16p+s*0xb));
                const zmm yc = mulpz4(wcp, getpz4(yq_s16p+s*0xc));
                const zmm yd = mulpz4(wdp, getpz4(yq_s16p+s*0xd));
                const zmm ye = mulpz4(wep, getpz4(yq_s16p+s*0xe));
                const zmm yf = mulpz4(wfp, getpz4(yq_s16p+s*0xf));

                const zmm a08 = addpz4(y0, y8); const zmm s08 = subpz4(y0, y8);
                const zmm a4c = addpz4(y4, yc); const zmm s4c = subpz4(y4, yc);
                const zmm a2a = addpz4(y2, ya); const zmm s2a = subpz4(y2, ya);
                const zmm a6e = addpz4(y6, ye); const zmm s6e = subpz4(y6, ye);
                const zmm a19 = addpz4(y1, y9); const zmm s19 = subpz4(y1, y9);
                const zmm a5d = addpz4(y5, yd); const zmm s5d = subpz4(y5, yd);
                const zmm a3b = addpz4(y3, yb); const zmm s3b = subpz4(y3, yb);
                const zmm a7f = addpz4(y7, yf); const zmm s7f = subpz4(y7, yf);

                const zmm js4c = jxpz4(s4c);
                const zmm js6e = jxpz4(s6e);
                const zmm js5d = jxpz4(s5d);
                const zmm js7f = jxpz4(s7f);

                const zmm a08p1a4c = addpz4(a08, a4c); const zmm s08mjs4c = subpz4(s08, js4c);
                const zmm a08m1a4c = subpz4(a08, a4c); const zmm s08pjs4c = addpz4(s08, js4c);
                const zmm a2ap1a6e = addpz4(a2a, a6e); const zmm s2amjs6e = subpz4(s2a, js6e);
                const zmm a2am1a6e = subpz4(a2a, a6e); const zmm s2apjs6e = addpz4(s2a, js6e);
                const zmm a19p1a5d = addpz4(a19, a5d); const zmm s19mjs5d = subpz4(s19, js5d);
                const zmm a19m1a5d = subpz4(a19, a5d); const zmm s19pjs5d = addpz4(s19, js5d);
                const zmm a3bp1a7f = addpz4(a3b, a7f); const zmm s3bmjs7f = subpz4(s3b, js7f);
                const zmm a3bm1a7f = subpz4(a3b, a7f); const zmm s3bpjs7f = addpz4(s3b, js7f);

                const zmm w8_s2amjs6e = w8xpz4(s2amjs6e);
                const zmm  j_a2am1a6e =  jxpz4(a2am1a6e);
                const zmm v8_s2apjs6e = v8xpz4(s2apjs6e);

                const zmm a08p1a4c_p1_a2ap1a6e = addpz4(a08p1a4c,    a2ap1a6e);
                const zmm s08mjs4c_pw_s2amjs6e = addpz4(s08mjs4c, w8_s2amjs6e);
                const zmm a08m1a4c_mj_a2am1a6e = subpz4(a08m1a4c,  j_a2am1a6e);
                const zmm s08pjs4c_mv_s2apjs6e = subpz4(s08pjs4c, v8_s2apjs6e);
                const zmm a08p1a4c_m1_a2ap1a6e = subpz4(a08p1a4c,    a2ap1a6e);
                const zmm s08mjs4c_mw_s2amjs6e = subpz4(s08mjs4c, w8_s2amjs6e);
                const zmm a08m1a4c_pj_a2am1a6e = addpz4(a08m1a4c,  j_a2am1a6e);
                const zmm s08pjs4c_pv_s2apjs6e = addpz4(s08pjs4c, v8_s2apjs6e);

                const zmm w8_s3bmjs7f = w8xpz4(s3bmjs7f);
                const zmm  j_a3bm1a7f =  jxpz4(a3bm1a7f);
                const zmm v8_s3bpjs7f = v8xpz4(s3bpjs7f);

                const zmm a19p1a5d_p1_a3bp1a7f = addpz4(a19p1a5d,    a3bp1a7f);
                const zmm s19mjs5d_pw_s3bmjs7f = addpz4(s19mjs5d, w8_s3bmjs7f);
                const zmm a19m1a5d_mj_a3bm1a7f = subpz4(a19m1a5d,  j_a3bm1a7f);
                const zmm s19pjs5d_mv_s3bpjs7f = subpz4(s19pjs5d, v8_s3bpjs7f);
                const zmm a19p1a5d_m1_a3bp1a7f = subpz4(a19p1a5d,    a3bp1a7f);
                const zmm s19mjs5d_mw_s3bmjs7f = subpz4(s19mjs5d, w8_s3bmjs7f);
                const zmm a19m1a5d_pj_a3bm1a7f = addpz4(a19m1a5d,  j_a3bm1a7f);
                const zmm s19pjs5d_pv_s3bpjs7f = addpz4(s19pjs5d, v8_s3bpjs7f);
#if 0
                const zmm h1_s19mjs5d_pw_s3bmjs7f = h1xpz4(s19mjs5d_pw_s3bmjs7f);
                const zmm w8_a19m1a5d_mj_a3bm1a7f = w8xpz4(a19m1a5d_mj_a3bm1a7f);
                const zmm h3_s19pjs5d_mv_s3bpjs7f = h3xpz4(s19pjs5d_mv_s3bpjs7f);
                const zmm  j_a19p1a5d_m1_a3bp1a7f =  jxpz4(a19p1a5d_m1_a3bp1a7f);
                const zmm hd_s19mjs5d_mw_s3bmjs7f = hdxpz4(s19mjs5d_mw_s3bmjs7f);
                const zmm v8_a19m1a5d_pj_a3bm1a7f = v8xpz4(a19m1a5d_pj_a3bm1a7f);
                const zmm hf_s19pjs5d_pv_s3bpjs7f = hfxpz4(s19pjs5d_pv_s3bpjs7f);

                setpz4(xq_sp+N0, addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N1, addpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f));
                setpz4(xq_sp+N2, addpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f));
                setpz4(xq_sp+N3, addpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f));
                setpz4(xq_sp+N4, subpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f));
                setpz4(xq_sp+N5, subpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f));
                setpz4(xq_sp+N6, subpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f));
                setpz4(xq_sp+N7, subpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f));

                setpz4(xq_sp+N8, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N9, subpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f));
                setpz4(xq_sp+Na, subpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f));
                setpz4(xq_sp+Nb, subpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f));
                setpz4(xq_sp+Nc, addpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f));
                setpz4(xq_sp+Nd, addpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f));
                setpz4(xq_sp+Ne, addpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f));
                setpz4(xq_sp+Nf, addpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f));
#else
                setpz4(xq_sp+N0, addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N8, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
    ...
    template <int n, int s> struct invcore
    {
                ...
                complex_vector x, complex_vector y, const_complex_vector W) const noexcept
        {
            ...
            for (int i = 0; i < Ni; i++) {
                ...
                setpz4(xq_sp+N0, addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N1, addpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f));
                setpz4(xq_sp+N2, addpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f));
                setpz4(xq_sp+N3, addpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f));
                setpz4(xq_sp+N4, addpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f));
                setpz4(xq_sp+N5, subpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f));
                setpz4(xq_sp+N6, subpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f));
                setpz4(xq_sp+N7, subpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f));

                setpz4(xq_sp+N8, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N9, subpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f));
                setpz4(xq_sp+Na, subpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f));
                setpz4(xq_sp+Nb, subpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f));
                setpz4(xq_sp+Nc, subpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f));
                setpz4(xq_sp+Nd, addpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f));
                setpz4(xq_sp+Ne, addpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f));
                setpz4(xq_sp+Nf, addpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f));
#else
                setpz4(xq_sp+N0, addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(xq_sp+N8, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
