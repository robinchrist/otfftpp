...
#include "otfftpp/detail/otfft_avxdif8omp.h"
...
#pragma omp for schedule(static)
            for (int i = 0; i < Ni; i++) {
                ...
                const zmm x8 = getpz4(xq_sp+N8);
                const zmm x9 = getpz4(xq_sp+N9);
                const zmm xa = getpz4(xq_sp+Na);
                const zmm xb = getpz4(xq_sp+Nb);
                const zmm xc = getpz4(xq_sp+Nc);
                const zmm xd = getpz4(xq_sp+Nd);
                const zmm xe = getpz4(xq_sp+Ne);
                const zmm xf = getpz4(xq_sp+Nf);

                const zmm a08 = addpz4(x0, x8); const zmm s08 = subpz4(x0, x8);
                const zmm a4c = addpz4(x4, xc); const zmm s4c = subpz4(x4, xc);
                const zmm a2a = addpz4(x2, xa); const zmm s2a = subpz4(x2, xa);
                const zmm a6e = addpz4(x6, xe); const zmm s6e = subpz4(x6, xe);
                const zmm a19 = addpz4(x1, x9); const zmm s19 = subpz4(x1, x9);
                const zmm a5d = addpz4(x5, xd); const zmm s5d = subpz4(x5, xd);
                const zmm a3b = addpz4(x3, xb); const zmm s3b = subpz4(x3, xb);
                const zmm a7f = addpz4(x7, xf); const zmm s7f = subpz4(x7, xf);
                ...
                setpz4(yq_s16p+s*0x0,             addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(yq_s16p+s*0x1, mulpz4(w1p, addpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f)));
                setpz4(yq_s16p+s*0x2, mulpz4(w2p, addpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f)));
                setpz4(yq_s16p+s*0x3, mulpz4(w3p, addpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f)));
                setpz4(yq_s16p+s*0x4, mulpz4(w4p, subpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f)));
                setpz4(yq_s16p+s*0x5, mulpz4(w5p, subpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f)));
                setpz4(yq_s16p+s*0x6, mulpz4(w6p, subpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f)));
                setpz4(yq_s16p+s*0x7, mulpz4(w7p, subpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f)));

                setpz4(yq_s16p+s*0x8, mulpz4(w8p, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f)));
                setpz4(yq_s16p+s*0x9, mulpz4(w9p, subpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f)));
                setpz4(yq_s16p+s*0xa, mulpz4(wap, subpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f)));
                setpz4(yq_s16p+s*0xb, mulpz4(wbp, subpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f)));
                setpz4(yq_s16p+s*0xc, mulpz4(wcp, addpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f)));
                setpz4(yq_s16p+s*0xd, mulpz4(wdp, addpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f)));
                setpz4(yq_s16p+s*0xe, mulpz4(wep, addpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f)));
                setpz4(yq_s16p+s*0xf, mulpz4(wfp, addpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f)));
            }
        }
    };
...
#pragma omp for schedule(static)
            for (int i = 0; i < Ni; i++) {
                ...
                setpz4(yq_s16p+s*0x0,             addpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f));
                setpz4(yq_s16p+s*0x1, mulpz4(w1p, addpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f)));
                setpz4(yq_s16p+s*0x2, mulpz4(w2p, addpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f)));
                setpz4(yq_s16p+s*0x3, mulpz4(w3p, addpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f)));
                setpz4(yq_s16p+s*0x4, mulpz4(w4p, addpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f)));
                setpz4(yq_s16p+s*0x5, mulpz4(w5p, subpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f)));
                setpz4(yq_s16p+s*0x6, mulpz4(w6p, subpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f)));
                setpz4(yq_s16p+s*0x7, mulpz4(w7p, subpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f)));

                setpz4(yq_s16p+s*0x8, mulpz4(w8p, subpz4(a08p1a4c_p1_a2ap1a6e,    a19p1a5d_p1_a3bp1a7f)));
                setpz4(yq_s16p+s*0x9, mulpz4(w9p, subpz4(s08pjs4c_pv_s2apjs6e, hf_s19pjs5d_pv_s3bpjs7f)));
                setpz4(yq_s16p+s*0xa, mulpz4(wap, subpz4(a08m1a4c_pj_a2am1a6e, v8_a19m1a5d_pj_a3bm1a7f)));
                setpz4(yq_s16p+s*0xb, mulpz4(wbp, subpz4(s08mjs4c_mw_s2amjs6e, hd_s19mjs5d_mw_s3bmjs7f)));
                setpz4(yq_s16p+s*0xc, mulpz4(wcp, subpz4(a08p1a4c_m1_a2ap1a6e,  j_a19p1a5d_m1_a3bp1a7f)));
                setpz4(yq_s16p+s*0xd, mulpz4(wdp, addpz4(s08pjs4c_mv_s2apjs6e, h3_s19pjs5d_mv_s3bpjs7f)));
                setpz4(yq_s16p+s*0xe, mulpz4(wep, addpz4(a08m1a4c_mj_a2am1a6e, w8_a19m1a5d_mj_a3bm1a7f)));
                setpz4(yq_s16p+s*0xf, mulpz4(wfp, addpz4(s08mjs4c_pw_s2amjs6e, h1_s19mjs5d_pw_s3bmjs7f)));
            }
        }
    };
